...
import com.svetlana.learn.borutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.svetlana.learn.borutoapp.ui.theme.LightGray
import com.svetlana.learn.borutoapp.ui.theme.StarColor
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    return mapOf(
        ...
        "halfFieldStars" to halfFilledStars,
...
fun FilledStarPreview() {
    ...
    FilledStar(starPath = starPath, starPathBounds = startPathBounds, scaleFactor = 3f)
}
...
fun HalfFilledStarPreview() {
    ...
    HalfFilledStar(starPath = starPath, starPathBounds = startPathBounds, scaleFactor = 3f)
}
...
fun EmptyFilledStarPreview() {
    ...
    EmptyStar(starPath = starPath, starPathBounds = startPathBounds, scaleFactor = 3f)
}
